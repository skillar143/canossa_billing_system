    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="active btn btn-outline-primary btn-sm mx-1" id="pills-home-tab" data-toggle="pill"
            data-target="#pills-pf" type="button" role="tab" aria-controls="pills-home" aria-selected="true">1<sup>st</sup> Semester</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="btn btn-outline-primary btn-sm mx-1" id="pills-profile-tab" data-toggle="pill"
            data-target="#pills-ps" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">2<sup>nd</sup> Semester</button>
        </li>
      </ul>
  </div>
